...
jkt['join'] = jkt['join'].str.replace('PETAMB', 'PETAMBURAN')
jkt['join'] = jkt['join'].str.replace('PONDOK INDAH', 'PONDOK PINANG')
...
kec_none=jkt.loc[jkt['kec'].isnull().sort_values(by=['join'], ascending=False)]
#st.dataframe(df_kec)
