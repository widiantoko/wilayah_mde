...
jkt['join'] = jkt['join'].str.replace('PLAZA ASIA', 'KEBAYORAN BARU')
...
jkt['join'] = jkt['join'].str.replace('CITYLOFTS SUDIRMAN', 'TANAH ABANG')
jkt['join'] = jkt['join'].str.replace('CITY LOFTS SUDIRMAN', 'TANAH ABANG')
...
jkt['join'] = jkt['join'].str.replace('SUDIRMAN KAV61', 'KEBAYORAN BARU')
jkt['join'] = jkt['join'].str.replace('SUDIRMAN KAV 61', 'KEBAYORAN BARU')
...
jkt['join'] = jkt['join'].str.replace('SUDIRMAN KAV 71', 'KEBAYORAN BARU')
jkt['join'] = jkt['join'].str.replace('SUDIRMAN NO 71', 'KEBAYORAN BARU')
...
jkt['join'] = jkt['join'].str.replace('SUDIRMAN KAV 27', 'SETIABUDI')
jkt['join'] = jkt['join'].str.replace('SUDIRMANKAV27', 'SETIABUDI')
jkt['join'] = jkt['join'].str.replace('SUDIRMAN KAV 28', 'SETIABUDI')
...
jkt['join'] = jkt['join'].str.replace('12910', 'SETIABUDI')
jkt['join'] = jkt['join'].str.replace('12920', 'SETIABUDI')
jkt['join'] = jkt['join'].str.replace('12930', 'SETIABUDI')
