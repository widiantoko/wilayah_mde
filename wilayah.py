...
pilihan=st.radio("A", key="A1", options= bulan, key=1, label_visibility= "collapsed",horizontal=True)
...
pilihan_A=st.radio("B", key="B1", options= bulan_A, label_visibility= "collapsed",horizontal=True)
