...
pilihan=st.radio("A", key="A", options= bulan, key=1, label_visibility= "collapsed",horizontal=True)
...
pilihan_A=st.radio("B", key="B", options= bulan_A, label_visibility= "collapsed",horizontal=True)
